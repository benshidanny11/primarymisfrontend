...
const yearReportDataHandler=(points)=>{
...
const maxCatMarksPerYer = tickets[tickets.length -1].report.maxMarks.maxCatMarks
const maxExamMarksPer = tickets[tickets.length -1].report.maxMarks.maxExamMarks
const maxTotalMarksPer = tickets[tickets.length -1].report.maxMarks.maxTotalMarks
// info on term one
const catOneSum = tickets[tickets.length -1].report.dataForTerms.term1.catOneSum.sum
const catTwoSum = tickets[tickets.length -1].report.dataForTerms.term1.catTwoSum.sum
const examSum = tickets[tickets.length -1].report.dataForTerms.term1.examSum.sum
// info on second term
const catOneSum2 = tickets[tickets.length -1].report.dataForTerms.term2.catOneSum.sum
const catTwoSum2 = tickets[tickets.length -1].report.dataForTerms.term2.catTwoSum.sum
const examSum2 = tickets[tickets.length -1].report.dataForTerms.term2.examSum.sum
// info on third term
const catOneSum3 = tickets[tickets.length -1].report.dataForTerms.term3.catOneSum.sum
const catTwoSum3 = tickets[tickets.length -1].report.dataForTerms.term3.catTwoSum.sum
const examSum3 = tickets[tickets.length -1].report.dataForTerms.term3.examSum.sum
// info on year
const totmarks = catOneSum+catTwoSum+examSum+catOneSum2+catTwoSum2+examSum2+catTwoSum3+catOneSum3+examSum3
...
const totaverage = ((totmarks*100)/totmax).toFixed(1)
 ...
 const  studentsInClass = tickets[tickets.length -1].report.studentsInClass
  //positions
  const term1position = tickets[tickets.length -1].report.dataForTerms.term1.position;
  const term2position = tickets[tickets.length -1].report.dataForTerms.term2.position
  const term3position = tickets[tickets.length -1].report.dataForTerms.term3.position
...
for (let i = 0; i < raw.length; i++) {
  ...
  row.push(raw[i].subject,
   ...
   (((term1[0]
      ...
      +term2[2]+term3[0]
      +term3[1]
      +term3[2])*100)/((raw[i].marks[0].catmax+ raw[i].marks[0].exammax)*3)).toFixed(1)
    )
  body.push(row)
  // body.push(term1);
    ...
    head: [
      [
        ...
        },
        {
          content: (((catOneSum+
            catTwoSum+
            examSum)*100)/maxTotalMarksPer).toFixed(1),
          colSpan: 4,
          rowSpan: 2,
           styles: {fillColor: [228, 242, 239],textColor:[65,74,76]  },
        },
        ...
        content: (((catOneSum2+
            catTwoSum2+
            examSum2)*100)/maxTotalMarksPer).toFixed(1),
          colSpan: 4,
          rowSpan: 2,
           styles: {fillColor: [228, 242, 239],textColor:[65,74,76]  },
        },
        {
          content: (((catOneSum3+
            catTwoSum3+
            examSum3)*100)/maxTotalMarksPer).toFixed(1),
          colSpan: 4,
          rowSpan: 2,
           styles: {fillColor: [228, 242, 239],textColor:[65,74,76]  },
        },
        {
          content: ((totmarks*100)/
            totmax).toFixed(1),
          colSpan: 3,
          rowSpan: 2,
           styles: {fillColor: [228, 242, 239],textColor:[65,74,76]  },
